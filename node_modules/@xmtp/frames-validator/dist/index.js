import { publicKey, frames, fetcher } from '@xmtp/proto';
import { bytesToHex } from '@noble/curves/abstract/utils';
import { secp256k1 } from '@noble/curves/secp256k1';
import { sha256 } from '@noble/hashes/sha256';
import { hashMessage, bytesToHex as bytesToHex$1, keccak256, getAddress } from 'viem/utils';
...
function verifyIdentityKeySignature(message, sig, bundle) {
    ...
    const isVerified = secp256k1.verify(sig.ecdsaCompact.bytes, digest, pubKey.secp256k1Uncompressed.bytes);
    if (!isVerified) {
        throw new Error("Invalid signature");
    }
}
...
export { XmtpValidator, deserializeProtoMessage, validateFramesPost };
