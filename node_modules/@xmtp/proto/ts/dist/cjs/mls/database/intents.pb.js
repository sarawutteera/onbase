    ...
    toJSON(message) {
        ...
        message.sendWelcomes !== undefined &&
            (obj.sendWelcomes = message.sendWelcomes
                ? exports.PostCommitAction_SendWelcomes.toJSON(message.sendWelcomes)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.sendWelcomes =
            object.sendWelcomes !== undefined && object.sendWelcomes !== null
                ? exports.PostCommitAction_SendWelcomes.fromPartial(object.sendWelcomes)
                : undefined;
        return message;
    },
};
...
exports.PostCommitAction_SendWelcomes = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.installations) {
            exports.PostCommitAction_Installation.encode(v, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.installations.push(exports.PostCommitAction_Installation.decode(reader, reader.uint32()));
                    break;
                case 2:
    ...
    fromJSON(object) {
        return {
            installations: Array.isArray(object === null || object === void 0 ? void 0 : object.installations)
                ? object.installations.map((e) => exports.PostCommitAction_Installation.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.installations) {
            obj.installations = message.installations.map((e) => e ? exports.PostCommitAction_Installation.toJSON(e) : undefined);
        }
        else {
            obj.installations = [];
        }
    ...
    fromPartial(object) {
        ...
        message.installations =
            ((_a = object.installations) === null || _a === void 0 ? void 0 : _a.map((e) => exports.PostCommitAction_Installation.fromPartial(e))) || [];
