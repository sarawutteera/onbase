...
export const Signature = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.erc1271 !== undefined) {
            Erc1271Signature.encode(message.erc1271, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.erc1271 = Erc1271Signature.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        return {
            ...
            erc1271: isSet(object.erc1271)
                ? Erc1271Signature.fromJSON(object.erc1271)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.erc1271 !== undefined &&
            (obj.erc1271 = message.erc1271
                ? Erc1271Signature.toJSON(message.erc1271)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.erc1271 =
            object.erc1271 !== undefined && object.erc1271 !== null
                ? Erc1271Signature.fromPartial(object.erc1271)
                : undefined;
