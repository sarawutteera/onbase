 ...
 */
export async function signerToSimpleSmartAccount(client, { signer, factoryAddress: _factoryAddress, entryPoint: entryPointAddress, index = BigInt(0), address, nonceKey }) {
    const viemSigner = {
        ...signer,
