...
async function sendUserOperation(client, args) {
    ...
    const userOperation = await (0, utils_1.getAction)(client, (prepareUserOperationRequest_1.prepareUserOperationRequest), "prepareUserOperationRequest")({ ...args, account });
