 ...
 * ]
 */
export declare const validateSponsorshipPolicies: <entryPoint extends EntryPoint, TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined>(client: Client<TTransport, TChain, TAccount, PimlicoPaymasterRpcSchema<entryPoint>>, args: Prettify<ValidateSponsorshipPoliciesParameters<entryPoint>>) => Promise<Prettify<ValidateSponsorshipPolicies>[]>;
