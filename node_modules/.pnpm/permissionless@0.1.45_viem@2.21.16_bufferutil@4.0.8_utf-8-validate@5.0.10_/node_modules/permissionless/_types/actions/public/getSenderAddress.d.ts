 ...
 */
export declare const getSenderAddress: <entryPoint extends EntryPoint, TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined>(client: Client<TTransport, TChain>, args: GetSenderAddressParams<entryPoint> extends infer T ? { [K in keyof T]: GetSenderAddressParams<entryPoint>[K]; } : never) => Promise<Address>;
