  ...
  if (approveTransaction?.data) {
    ...
    if (!useAggregator) {
      ...
      const data = encodeFunctionData({
        ...
        args: [quote.from.address, UNIVERSALROUTER_CONTRACT_ADDRESS, BigInt(quote.fromAmount), 20_000_000_000_000 // The deadline where the approval is no longer valid - see https://docs.uniswap.org/contracts/permit2/reference/allowance-transfer
        ]
      });
      transactions.push({
        transaction: {
