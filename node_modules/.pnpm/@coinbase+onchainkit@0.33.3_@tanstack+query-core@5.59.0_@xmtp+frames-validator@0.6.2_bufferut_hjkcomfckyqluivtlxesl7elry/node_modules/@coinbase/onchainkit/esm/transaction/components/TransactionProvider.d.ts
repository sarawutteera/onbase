...
export declare function TransactionProvider({ calls, capabilities, chainId, children, contracts, onError, onStatus, onSuccess, }: TransactionProviderReact): import("react/jsx-runtime").JSX.Element;
