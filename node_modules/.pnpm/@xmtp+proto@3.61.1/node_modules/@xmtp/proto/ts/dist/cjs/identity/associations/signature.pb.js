...
exports.Signature = exports.LegacyDelegatedSignature = exports.Erc1271Signature = exports.RecoverableEd25519Signature = exports.RecoverableEcdsaSignature = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseErc1271Signature() {
    return {
        accountId: "",
...
exports.Erc1271Signature = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseErc1271Signature();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.Signature = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.erc1271 !== undefined) {
            exports.Erc1271Signature.encode(message.erc1271, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.erc1271 = exports.Erc1271Signature.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        return {
            erc191: isSet(object.erc191)
                ...
                : undefined,
            erc1271: isSet(object.erc1271)
                ? exports.Erc1271Signature.fromJSON(object.erc1271)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.erc191 !== undefined &&
            (obj.erc191 = message.erc191
                ...
                : undefined);
        message.erc1271 !== undefined &&
            (obj.erc1271 = message.erc1271
                ? exports.Erc1271Signature.toJSON(message.erc1271)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.erc191 =
            object.erc191 !== undefined && object.erc191 !== null
                ...
                : undefined;
        message.erc1271 =
            object.erc1271 !== undefined && object.erc1271 !== null
                ? exports.Erc1271Signature.fromPartial(object.erc1271)
                : undefined;
