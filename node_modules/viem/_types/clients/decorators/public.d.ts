...
export type PublicActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     */
    estimateFeesPerGas: <chainOverride extends Chain | undefined = undefined, type extends FeeValuesType = 'eip1559'>(args?: EstimateFeesPerGasParameters<chain, chainOverride, type> | undefined) => Promise<EstimateFeesPerGasReturnType>;
    /**
