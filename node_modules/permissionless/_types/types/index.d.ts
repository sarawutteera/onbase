...
export type GetAccountParameter<entryPoint extends EntryPoint, TTransport extends Transport, TChain extends Chain | undefined, TAccount extends SmartAccount<entryPoint, string, TTransport, TChain> | undefined> = IsUndefined<TAccount> extends true ? {
