...
const getFactoryAddress = (entryPoint, factoryAddress) => {
    if (factoryAddress)
        return factoryAddress;
    if ((0, utils_1.getEntryPointVersion)(entryPoint) === "v0.6") {
        return "0x9406Cc6185a346906296840746125a0E44976454";
    }
    return "0x91E60e0613810449d098b0b5Ec8b51A0FE8c8985";
};
async function signerToSimpleSmartAccount(client, { signer, factoryAddress: _factoryAddress, entryPoint: entryPointAddress, index = BigInt(0), address, nonceKey }) {
    const viemSigner = {
        ...signer,
