 ...
 */
export async function signerToLightSmartAccount(client, { signer, address, lightAccountVersion, entryPoint: entryPointAddress, index = BigInt(0), factoryAddress: _factoryAddress, nonceKey }) {
    const viemSigner = {
        ...signer,
