...
import { cn, background, border, pressable } from '../../styles/theme.js';
...
function SwapSettingsSlippageLayout({
  ...
  return /*#__PURE__*/jsxs("div", {
    className: cn(background.default, border.default, pressable.shadow, 'right-0 z-10 w-[21.75rem] rounded-lg px-3 py-3', className),
